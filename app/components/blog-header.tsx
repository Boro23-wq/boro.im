  ...
  return (
    <div className="mb-6 flex items-center justify-between gap-4">
      ...
      <button
        ...
        className="flex items-center justify-center w-8 h-8 text-neutral-500 hover:text-neutral-700 dark:hover:text-neutral-300 transition-colors border border-neutral-200 dark:border-neutral-800 rounded-sm hover:bg-neutral-50 dark:hover:bg-neutral-900/50 motion-safe:active:scale-[0.98] motion-safe:transition-transform"
      >
