...
highlightDescription: Enrollee-centered, goal-oriented care tools.
---
...
<Table
  data={{
    headers: ["#", "Stakeholder", "Use case"],
    rows: [
      [
        "1.",
        "Patients",
        "Retrieve case information, monitor case health, and access self-service.",
      ],
      [
        "2.",
        "Medical practitioners",
        "Access patient information to build personalized case plan, and perform risk evaluation.",
      ],
      ...
      [
        "5.",
        "Case managers",
        "Maintains external data, determines plan objectives and suggests health recommendations.",
      ],
      [
        "6.",
        "PM/BA's",
        "Responsible for gathering and prioritizing requirements of the case notes system.",
      ],
      [
        "7.",
        "Development team",
        "Responsible for design and implementation of the case notes backend and frontend system.",
      ],
    ],
  }}
/>
...
5. <u>Results statement</u> - Evaluation of the meeting in relation to the purpose. - Should
   disclose if purpose was achieved or not.
6. <u>Impression statement</u> - Links case manager’s plan.
7. <u>Plan statement</u> - should include next steps assignment. - Should include the next meeting
   date. - Connected to Immediate Plan (IP). - Include reasons for the next meeting.

## Example - User Persona

<Image src="/projects/carely/user-persona.png" alt="persona" priority width="800" height="800" />
...
1. <u>As an admin:</u>- I should be able to create, and manage case managers, so that I can assure
   appropriate medical care for the patients.

2. <u>As a case manager:</u>- I should be able to create, and manage a case, so that I can retrieve
   a clients’ case information and case history on demand. - I should be able to attach top-level
   categories to a case, so that it is easier to retrieve cases based on the category. - I should be
   able to attach severity definitions to the case, so that volatile cases can be monitored closely.
   - I should be able to implement a dedicated client plan, so that the efficacy of a plan can be
   closely monitored. - I should be able to create a case note, on any of my cases, so that I can
   retrieve notes in the future while dealing with a case.
...
- **<u>Next.js</u>** - Production ready applications and scales.
- **<u>Typescript</u>** - For type-safety.
- **<u>Tailwind CSS</u>** - Next generation Typescript and Node ORM.
- **<u>Iron-session</u>** - Node.js stateless session utility.
- **<u>Vercel</u>** - Seamless deployment and scaling.

## Tech Stack (Backend)

- **<u>Postman</u>** - Design and test API.
- **<u>Jest + Supertest</u>** - E2E testing.
- **<u>Nest.js</u>** - Progressive Node.js framework.
- **<u>Typescript</u>** - For type-safety
- **<u>Prisma</u>** - Next generation Typescript and Node ORM.
- **<u>Planetscale</u>** - Scalable MYSQL platform.
- **<u>Vercel</u>** - Serverless, event-driven compute service.
...
<Carousel
  imgs="/projects/carely/carousel/1.png,/projects/carely/carousel/2.png,/projects/carely/carousel/3.png,/projects/carely/carousel/4.png,/projects/carely/carousel/5.png,/projects/carely/carousel/6.png,/projects/carely/carousel/7.png"
  subtitle="Carely screens"
/>
