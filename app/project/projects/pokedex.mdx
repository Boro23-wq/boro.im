...
<Image src="/blog/csr-ssr-ssg/csr-steps.png" alt="csr-steps" width={800} height={800} />
...
<div>
  <Image src="/blog/csr-ssr-ssg/ssr-steps.png" alt="ssr-steps" width={800} height={800} />
</div>
...
<div>
  <Image src="/blog/csr-ssr-ssg/ssg-steps.png" alt="ssg-steps" width={800} height={800} />
</div>
...
<Table
  data={{
    ...
    rows: [
      [
        "Authenticated pages or paywall/private dashboard pages.",
        "Can be used with pages that require a heavy workload.",
        "Documentation pages where data is not frequently updated.",
      ],
      [
        "Pages with frequent data updates. For eg. Pages with real-time data updates.",
        "Websites that require link previews.",
        "Blog sites.",
      ],
      [
        "Banking websites where data is requested on-demand.",
        "Websites with lots of pages (only render on request).",
        "Great for isomorphic applications/websites.",
      ],
      [
        "Pages that don't require SEO optimizations.",
        "Pages that do require SEO optimizations.",
        "Pages that do require SEO optimizations.",
      ],
    ],
  }}
