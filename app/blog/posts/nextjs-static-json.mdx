...
const Song = ({ id, name, artist, albumCoverUrl }) => (
  <ListItem border="1px solid" borderColor="gray.200" borderRadius={4} my={2} bg="white">
...
<Image width="800" height="800" src="/blog/nextjs-static-json/app-1.png" alt="app-screen-1" />
...
<Image width="800" height="800" src="/blog/nextjs-static-json/app-2.gif" alt="application-demo" />
