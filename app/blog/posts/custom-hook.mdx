...
<u>Note</u>: I have only highlighted the src folder since we will only be working inside this
directory.
...
<Image width="800" height="800" src="/blog/custom-hook/final.png" alt="application-demo" />
